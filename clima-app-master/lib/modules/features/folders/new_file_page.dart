...
class NewFilePage extends GetWidget<NewFileController> {
      ...
      body: Column(
        ...
        children: [
          ...
          AppTextField(
            ...
            outline: false,
            transparent: true,
            hit: 'Masukan url file',
            contentPadding: 8.0.allEdge,
            borderRadius: BorderRadius.zero,
            onChanged: (p0) => controller.linkUrl.value = p0,
            controller: TextEditingController(
              text: controller.args.data?.linkUrl ?? '',
            ),
          ),
          24.0.verticalSpace,
          Padding(
            ...
            child: Obx(() {
              return AppButton(
                ...
                enable:
                    controller.name.isNotEmpty && controller.linkUrl.isNotEmpty,
